...
const { addImage, changSelectedeImage } = actions;
...
class Gallary extends Component {
  ...
  render() {
    const { images, changSelectedeImage } = this.props;
    return (
...
export default connect(mapStateToProps, { addImage, changSelectedeImage })(
  Gallary
);
